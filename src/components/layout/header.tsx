  ...
  return (
    ...
    <header className="flex h-14 items-center gap-3 border-b bg-background/95 px-5 backdrop-blur-sm">
      ...
      <div className="relative" ref={plusRef}>
        ...
        {plusOpen && (
          <div className="absolute left-0 top-full mt-2.5 w-64 overflow-hidden rounded-2xl border bg-popover shadow-2xl ring-1 ring-black/5 z-50 animate-in fade-in slide-in-from-top-1 duration-150">
            <div className="p-2">
              {([
                {
                  icon: BookOpen,
                  label: "Lernset",
                  description: "Neues Deck erstellen",
                  href: "/create",
                ...
                {
                  icon: Camera,
                  label: "Erfassen & Lernen",
                  description: "Bild mit KI analysieren",
                  href: "/capture",
                ...
                },
                {
                  icon: PlusCircle,
                  label: "Cornell-Notiz",
                  description: "Notiz nach Cornell-Methode",
                  href: "/notes",
                ...
                },
                {
                  icon: FolderPlus,
                  label: "Ordner",
                  description: "Decks organisieren",
                  href: "/dashboard",
